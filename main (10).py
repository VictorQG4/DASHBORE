...
@st.cache_data
def cargar_datos():
    df = pd.read_excel('/mnt/data/Entrenamiento_R3.xlsx')
...
if df_asesor.empty:
    ...
    # --- Gráfico: Duración total por fecha ---
